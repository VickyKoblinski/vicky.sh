...
export function TrailLab({
  ...
  return (
    <details
      className="absolute right-[max(32px,calc((100vw-1120px)/2+32px))] bottom-[18px] z-[2] w-[205px] rounded-lg border border-white/80 bg-white/85 px-3 py-[10px] text-[.72rem] max-[720px]:right-5"
